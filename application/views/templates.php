...
<head>
	...
	<link rel="shortcut icon" href="<?= base_url('assets/templates/')?>favicon.png">
	...
	<link rel="stylesheet" href="<?= base_url('assets/templates/')?>css/owl.theme.default.min.css">
	<link rel="stylesheet" href="<?= base_url('assets/templates/')?>css/jquery.fancybox.min.css">
	<link rel="stylesheet" href="<?= base_url('assets/templates/')?>fonts/icomoon/style.css">
	<link rel="stylesheet" href="<?= base_url('assets/templates/')?>fonts/flaticon/font/flaticon.css">
	<link rel="stylesheet" href="<?= base_url('assets/templates/')?>css/daterangepicker.css">
	<link rel="stylesheet" href="<?= base_url('assets/templates/')?>css/aos.css">
...
<body>
    ...
    <div class="container">
        <div class="site-navigation">
            <!-- Logo -->
            <a href="<?= base_url() ?>" class="logo m-0">Tour <span class="text-primary">.</span></a>
            ...
            <ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
                ...
                <!-- Search -->
                <li>
                    <form class="form-inline my-2 my-lg-0" method="get" action="<?= base_url('auth') ?>">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                <div class="intro-wrap">
                    <h1 class="mb-5">
                        <span class="d-block">Let's Enjoy Your</span> 
                        Trip In <span class="typed-words"></span>
                    </h1>

					<form class="form w-100" action="<?= base_url('user/jadwal/cari') ?>" method="get">
					<div class="row mb-3">
						
						<!-- Stasiun Asal -->
						<!-- Stasiun Asal -->
					<div class="col-sm-12 col-md-6 col-lg-4 mb-3">
						<select name="asal" id="asal" class="form-control select2">
							<option value="">Stasiun Asal</option>
							<?php foreach ($stasiun_awal as $s): ?>
								<option value="<?= $s->stasiun_awal ?>"><?= ucfirst($s->stasiun_awal) ?></option>
							<?php endforeach; ?>
						</select>
					</div>
					...
					<div class="col-sm-12 col-md-6 col-lg-4 mb-3">
						<select name="tujuan" id="tujuan" class="form-control select2">
							...
							<?php foreach ($stasiun_akhir as $s): ?>
								<option value="<?= $s->stasiun_akhir ?>"><?= ucfirst($s->stasiun_akhir) ?></option>
							<?php endforeach; ?>
						</select>
					</div>
						...
						<!-- Jumlah Orang -->
						<div class="col-sm-12 col-md-6 col-lg-4 mb-3">
						<input type="number" class="form-control" name="people" placeholder="Jumlah Orang">
						</div>
					</div>
                ...
                <div id="heroCarousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= base_url('assets/kereta1.png')?>" class="d-block w-100" alt="Slide 1">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= base_url('assets/kereta2.png')?>" class="d-block w-100" alt="Slide 2">
                        </div>
                        <div class="carousel-item">
                            <img src="images/hero-slider-3.jpg" class="d-block w-100" alt="Slide 3">
                        </div>
                        <div class="carousel-item">
                            <img src="images/hero-slider-4.jpg" class="d-block w-100" alt="Slide 4">
                        </div>
                        <div class="carousel-item">
                            <img src="images/hero-slider-5.jpg" class="d-block w-100" alt="Slide 5">
                        </div>
                    </div>
	...
	<script src="<?= base_url('assets/templates/')?>js/popper.min.js"></script>
	...
	<script src="<?= base_url('assets/templates/')?>js/jquery.animateNumber.min.js"></script>
	<script src="<?= base_url('assets/templates/')?>js/jquery.waypoints.min.js"></script>
	<script src="<?= base_url('assets/templates/')?>js/jquery.fancybox.min.js"></script>
	<script src="<?= base_url('assets/templates/')?>js/aos.js"></script>
	<script src="<?= base_url('assets/templates/')?>js/moment.min.js"></script>
	<script src="<?= base_url('assets/templates/')?>js/daterangepicker.js"></script>
	...
	$(document).ready(function() {
		$('.select2').select2({
			...
			allowClear: true,
			width: '100%' // biar penuh seperti form biasa
		});
	});
	</script>
